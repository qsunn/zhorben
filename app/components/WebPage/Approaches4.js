        ...
        <ul className="w-full flex flex-col md:flex-row gap-8">
          {approachList.map((item) => {
            return (
              ...
              >
                <div
                  className={`${s.bgImage} place-self-center lg:place-self-start shrink-0 h-24 w-24 bg-[url('./images/icon_crossed_circles.svg')] dark:bg-[url('./images/icon_crossed_circles_dark.svg')]`}
                />
