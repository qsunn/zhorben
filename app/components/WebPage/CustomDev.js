    ...
    <section className={s.container}>
      <div className="w-full">
        <div className=" flex flex-col gap-7">
          ...
          <h6 className={`${s.h6titleM} text-secondary-light dark:text-secondary-dark text-center mb-20`}>
        ...
        <ul className={`lg:min-w-[26.875rem] box1 flex flex-col`}>
          {table.map((item) => {
            return (
              <li
                key={item}
                className="flex flex-row justify-between px-7 py-7 sm:px-12 sm:py-7 gap-3 border-[#E0E0E0] border-t border-x last:border-b first:rounded-t-2xl last:rounded-b-2xl"
              >
