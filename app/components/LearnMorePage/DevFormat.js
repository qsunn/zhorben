    ...
    <section className={s.container}>
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-32 mb-32">
          <div
            className={`${s.image} md:hidden bg-right w-full h-80 bg-[url('./images/graph_1.svg')]`}
          />
          ...
          <div
            className={`${s.image} hidden md:block bg-right w-full h-80 bg-[url('./images/graph_1.svg')]`}
          />
          <div
            className={`${s.image} bg-left w-full h-80 bg-[url('./images/graph_2.png')]`}
          />
          <div className="flex flex-col gap-5 items-start">
