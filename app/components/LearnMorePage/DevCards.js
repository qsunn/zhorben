    ...
    <div className="flex flex-col gap-16">
        ...
        <div className="flex flex-col sm:flex-row lg:flex-col items-center gap-5">
          ...
          <div className="flex flex-col">
            ...
            <p className={`${s.p4book} text-secondary-light dark:text-secondary-dark`}>
              ...
              your UI through your customers&apos; eyes. Our progressive UI
              development also saves you time and money, because it eliminates
              late, unexpected scope changes.
            </p>
          </div>
        </div>
        <div className="flex flex-col sm:flex-row lg:flex-col items-center gap-5">
          ...
          <div className="flex flex-col">
            ...
            <p className={`${s.p4book} text-secondary-light dark:text-secondary-dark`}>
              ...
              clients, including the highest product quality, lowest costs, and
              fastest releases.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row lg:flex-col items-center gap-5">
          ...
          <div className="flex flex-col">
            ...
            <p className={`${s.p4book} text-secondary-light dark:text-secondary-dark`}>
              ...
              provide strict version control and automatic code and data backups
              to ensure product continuity and protect you against critical data
              loss.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <h6 className={`${s.h6titleM} text-secondary-light dark:text-secondary-dark text-center`}>
          ...
          help your marketing team maximize conversions, revenue, and profits.
          Our engineers integrate your goals and metrics to build conversion
          funnels, going far beyond simple tracking pixels.
        </h6>
