                    ...
                    {employeesData.map((employee, i) => {
                        return (
                            <div className="keen-slider__slide" key={employee.name}>
                                <ReviewCard employee={employee} index={i} currentSlide={currentSlide} />
                            </div>
                        )
                    })}
                </div>
                {loaded && instanceRef.current && (
                    <>
                        <button
                            ...
                            className="ellipse bg-[#EFEFEF] rounded-full p-3 absolute -left-16 top-1/2 -translate-y-1/2"
                        >
                        ...
                        <button
                            ...
                            disabled={
                                currentSlide === employeesData.length - 1
                            }
                            className="ellipse bg-[#EFEFEF] rounded-full p-3 absolute -right-16 top-1/2 -translate-y-1/2"
                        >
