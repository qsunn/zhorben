...
export const Offer = () => {
  return (
    <section className={`${s.container}`}>
      ...
      <div className={"w-full grid gap-5 grid-flow-row lg:grid-flow-col"}>
        <div
          className={`box w-full p-10 flex flex-col gap-5 bg-center bg-no-repeat !bg-cover !bg-[url('./images/bg_squares.png')]`}
        >
